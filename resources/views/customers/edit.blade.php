                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="@error('customer.ttl')border border-danger rounded-3 @enderror">
                                    <input class="form-control" value="{{ $cr->ttl }}" type="date" placeholder="Pilih Tanggal" id="customer-ttl" name="ttl">
                                    @error('ttl')
                                    <p class="text-danger text-xs mt-2">{{ $message }}</p>
                                    @enderror
                                </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <div class="@error('no_hp')border border-danger rounded-3 @enderror">
                                    <input class="form-control" value="{{ $customer->customers->no_hp }}" type="no_hp" placeholder="08**********" id="customer-no_hp" name="no_hp">
                                        @error('no_hp')
                                            <p class="text-danger text-xs mt-2">{{ $message }}</p>
                                        @enderror
                                </div>
