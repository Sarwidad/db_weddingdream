...
<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 " id="sidenav-main">
  <div class="sidenav-header">
    ...
    <a class="align-items-center d-flex m-0 navbar-brand text-wrap" href="{{ route('dashboard') }}">
        <img src="../assets/img/logo-wd.jpeg" class="navbar-brand-img h-100" alt="...">
        <span class="ms-3 font-weight-bold">Admin <br> Wedding Dream</span>
    </a>
  </div>
  ...
  <div class="collapse navbar-collapse  w-auto" id="sidenav-collapse-main">
    <ul class="navbar-nav">
      ...
      <li class="nav-item mt-2">
        <h6 class="ps-4 ms-2 text-uppercase text-xs font-weight-bolder opacity-6">Data Pengguna</h6>
      </li>
      <li class="nav-item pb-2">
      ...
      <li class="nav-item pb-2">
        <a class="nav-link {{ (Request::is('vendors') ? 'active' : '') }}" href="{{ url('vendors') }}">
            ...
            <span class="nav-link-text ms-1">Data Vendor</span>
        </a>
      </li>
      <li class="nav-item pb-2">
        <a class="nav-link {{ (Request::is('konsultans') ? 'active' : '') }}" href="{{ url('konsultans') }}">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                <i style="font-size: 1rem;" class="fas fa-lg fa-list-ul ps-2 pe-2 text-center text-dark {{ (Request::is('konsultans') ? 'text-white' : 'text-dark') }} " aria-hidden="true"></i>
            </div>
            <span class="nav-link-text ms-1">Data Wedding Konsultan</span>
        </a>
      </li>
      <!-- <li class="nav-item">
