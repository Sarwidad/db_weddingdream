...
<div>
    <div class="container-fluid">
        <div class="page-header min-height-300 border-radius-xl mt-4" style="background-image: url('../assets/img/curved-images/curved0.jpeg'); background-position-y: 50%;">
        </div>
                ...
                <div class="col-auto my-auto">
                    <div class="h-100">
                        ...
                        <p class="mb-0 font-weight-bold text-sm">
                            {{ __(' Admin Wedding Dream') }}
                        </p>
                        <p class="mb-0 font-weight-bold text-sm">
                            {{ __(' PT. Youth Digital Innovation') }}
                        </p>
                    </div>
                </div>
            ...
            <div class="card-body pt-4 p-3">
                <form action="/admin-profile" method="POST" role="form text-left">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                <label for="user-name" class="form-control-label">{{ __('Nama Lengkap :') }}
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                <label for="user.username" class="form-control-label">{{ __('Username :') }}
                                <span style="color:red;" class="required has-text-danger">*</span>
                                </label>
                                <div class="@error('user.username') border border-danger rounded-3 @enderror">
                                    <input class="form-control" type="text" placeholder="Username   " id="name" name="username" value="{{ auth()->user()->username }}">
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                <label for="user-email" class="form-control-label">{{ __('Email :') }}
                                <span style="color:red;" class="required has-text-danger">*</span>
                                </label>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                <label for="user.password" class="form-control-label">{{ __('Password :') }}
                                <span style="color:red;" class="required has-text-danger">*</span>
                                </label>
                                <div class="@error('user.password') border border-danger rounded-3 @enderror">
                                    <input class="form-control" type="text" placeholder="Location" id="name" name="password" value="{{ auth()->user()->password }}">
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                <label for="user.phone" class="form-control-label">{{ __('No Hp :') }}
                                <span style="color:red;" class="required has-text-danger">*</span>
                                </label>
                                <div class="@error('user.phone')border border-danger rounded-3 @enderror">
                                    <input class="form-control" type="tel" placeholder="08**********" id="number" name="phone" value="{{ auth()->user()->phone }}">
                                        @error('phone')
                                            <p class="text-danger text-xs mt-2">{{ $message }}</p>
                                        @enderror
                                </div>
